<footer>
    <section class=" bg-[#06385F] relative">
        <div class="block_content py-[30px] px-[30px] lg:px-[112px]" style="padding-top:100px; padding-bottom:25px">
            <div class="lg:mt-[100px] flex flex-wrap lg:flex-nowrap">
                <div class="mb-[90px] lg:mb-0 w-full lg:w-[30%] text-center lg:text-start">
                    <a href="/home"> <img class="w-[150px]" src="<?php echo  get_stylesheet_directory_uri() ?>/assets/images/bh-logopng.png" alt=""> </a>
                    <p class="text-[#ffffffad] my-[35px] font-[400] lg:w-[90%] text-start text-[16px]"><?php the_field('footer_paragraph', 'option'); ?></p>
