...
<section class="bg-[#06385F] relative">
    ...
    <img class="lg:hidden block absolute z-10 right-0 lg:right-0 h-[540px]  <?php echo ($home_hero == "Yes") ? 'bottom-[-10px]' : 'top-0' ?> " src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/hexagon-5.svg" alt="">
